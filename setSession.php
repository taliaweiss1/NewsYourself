...
<?php
    if(isset($_POST['username']) && isset($_POST['password'])){
		...
		//get all of users to see if the username matches one of our registered users
		...
		//if username matches, check to see if the passwords match
		if($usernameMatches){
			require 'database.php';
			...
			if(password_verify($pwd_guess, $pwd_hash)){
				...
				// Login failed; redirect to wrong password screen
